...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between mb-3">
            <asp:Button ID="btnDescargarMostrarModal" runat="server" Text="Descargar Lista de Reservas" OnClientClick="setTimeout(function() { mostrarModalExitoPersonalizado('Descarga exitosa', 'La lista de reservas fue descargada correctamente.'); }, 1000);" OnClick="btnDescargar_Click" CssClass="btn btn-dark" />
        </div>
    </div>
